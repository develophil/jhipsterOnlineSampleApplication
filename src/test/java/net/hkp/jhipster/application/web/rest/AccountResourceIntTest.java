package net.hkp.jhipster.application.web.rest;

import net.hkp.jhipster.application.config.Constants;
import net.hkp.jhipster.application.JhipsterOnlineSampleApplicationApp;
import net.hkp.jhipster.application.domain.Authority;
import net.hkp.jhipster.application.domain.User;
import net.hkp.jhipster.application.repository.AuthorityRepository;
import net.hkp.jhipster.application.repository.UserRepository;
import net.hkp.jhipster.application.security.AuthoritiesConstants;
import net.hkp.jhipster.application.service.MailService;
import net.hkp.jhipster.application.service.dto.UserDTO;
import net.hkp.jhipster.application.web.rest.errors.ExceptionTranslator;
import net.hkp.jhipster.application.web.rest.vm.KeyAndPasswordVM;
import net.hkp.jhipster.application.web.rest.vm.ManagedUserVM;
import net.hkp.jhipster.application.service.UserService;
...
@SpringBootTest(classes = JhipsterOnlineSampleApplicationApp.class)
