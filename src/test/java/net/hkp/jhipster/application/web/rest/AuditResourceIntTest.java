...
import net.hkp.jhipster.application.config.audit.AuditEventConverter;
import net.hkp.jhipster.application.domain.PersistentAuditEvent;
import net.hkp.jhipster.application.repository.PersistenceAuditEventRepository;
import net.hkp.jhipster.application.service.AuditEventService;
